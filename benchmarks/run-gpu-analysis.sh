...
declare -xr CONDA_ENV_YAML="${CONDA_CACHE_DIR}/tensorflow-gpu.yaml"
...
python3 tf2-train-cnn-cifar-v1.py --classes 10 --precision fp32 --epochs 42 --batch_size 256 --accelerator gpu --savekeras True
