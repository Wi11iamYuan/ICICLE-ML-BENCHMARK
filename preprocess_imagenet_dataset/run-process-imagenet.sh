...
declare -xr CONDA_ENV_YAML="/home/${SLURM_JOB_ACCOUNT}/$/ICICLE-ML-BENCHMARK/benchmarks/environments/imagenet-process.yaml"
...
time -p python3 preprocess-imagenet-expanse.py
